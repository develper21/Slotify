                                ...
                                {notifications.length === 0 ? (
                                    ...
                                    <div className="divide-y divide-neutral-800/50">
                                        {notifications.map((n) => (
                                            <div
                                                key={n.id}
                                                className={`p-4 hover:bg-neutral-900/50 transition-colors relative group ${!n.is_read ? 'bg-mongodb-spring/5' : ''}`}
                                            >
                                                <div className="flex gap-4">
                                                    <div className={`w-2 h-2 rounded-full mt-1.5 shrink-0 ${!n.is_read ? 'bg-mongodb-spring' : 'bg-transparent'}`} />
