                                ...
                                >
                                    <div className="flex items-center justify-between mb-3">
                                        <label className="flex items-center gap-3 cursor-pointer">
                                            ...
                                            />
                                            <span className="font-semibold text-neutral-900">{day.name}</span>
                                        </label>
                                        {schedule.is_working_day && (
                                        ...
                                        <div className="flex items-center gap-4">
                                            <div className="flex-1">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full px-4 py-2 rounded-lg border border-neutral-300 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 transition-all outline-none"
                                                />
                                            </div>
                        ...
                        <div className="space-y-3">
                            {schedules
                                ...
                                .map((schedule, index) => {
                                    ...
                                    return (
                                        <div key={schedule.day_of_week} className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
